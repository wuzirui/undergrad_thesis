...
NeRF         & 26.56          & 0.087          & 0.83           & 0.905          & 0.91           \\
...
PSNR $\uparrow$    & 18.83 & 23.34 & 24.18  & 26.66          & \textbf{27.159} \\
SSIM $\uparrow$    & 0.59  & 0.662 & 0.677  & \textbf{0.806} & 0.798           \\
LPIPS $\downarrow$ & 0.456 & 0.415 & 0.425  & 0.186          & \textbf{0.176}  \\ \hline
\end{tabular}%
}
